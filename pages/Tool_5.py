...
row = _load_tool5_row(GOOGLE_SHEET_ID, tool_name, tpm_id, TPM_COL)

if not row:
    st.error("The selected TPM ID was not found in the Tool 5 worksheet.")
    st.stop()
