...
row = _load_tool7_row(GOOGLE_SHEET_ID, tool_name, tpm_id, TPM_COL)

if not row:
    st.error("The selected TPM ID was not found in the Tool 7 worksheet.")
    st.stop()
